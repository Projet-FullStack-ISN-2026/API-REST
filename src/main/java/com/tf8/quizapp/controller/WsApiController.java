...
public class WsApiController implements WsApi {
    ...
    public ResponseEntity<Void> wsQuizQuizIdGet(@Parameter(in = ParameterIn.PATH, description = "ID unique du quiz.", required=true, schema=@Schema()) @PathVariable("quizId") Long quizId
) {
